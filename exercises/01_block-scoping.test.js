...
/*
  1. The scope of let/const is within the block it's declared. Use {} to create a block.
  2. Multiple things can create block, such as function, for-loop, etc.
  3. let/const can be modified even in the next block. See the second test for an example.
*/